...
4. Detect fork mode:
   - If remotes include both `xzxiong/<repo>` and `matrixorigin/<repo>`, push to the fork and open PR against upstream.
...
6. Push the branch.
7. Reuse an existing open PR for the branch or create one.
